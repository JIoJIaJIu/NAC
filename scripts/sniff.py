...
def normalize_range(ranges):
    [ask, res] = ranges
    return [
        utils.count_duration(ask, res), #continuous.
        utils.get_protocol(ask), #symbolic.
        utils.get_service(ask), #symbolic.
        utils.get_flag(ask), #symbolic. 
        utils.get_src_bytes(ask), #continuous.
        utils.get_dst_bytes(res), #continuous.
        0, #symbolic.
        0, #continuous.
        0, #continuous.
        0, #continuous.
